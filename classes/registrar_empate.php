...
$sql2 = "UPDATE equipos SET puntos=$puntosNuevos WHERE idEquipos=$idParticipante1";
...
$sql2 = "UPDATE equipos SET puntos=$puntosNuevos WHERE idEquipos=$idParticipante2";
$insertar = mysqli_query($conexion, $sql2);
?>